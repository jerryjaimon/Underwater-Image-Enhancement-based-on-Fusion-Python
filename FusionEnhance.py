from Python.FeatureWeight import LaplacianContrast, LocalContrast, Saliency, Exposedness
from Python.ImageDecompose import fuseTwoImages
from Python.SimplestColorBalance import simplest_cb
import numpy as np
import cv2
import time
...
if __name__ ==   '__main__':
    path = "D:\\VIT\\Academics\\Sem5\\Image\\Project Try 2\\Images\\green_water_4.jpg"
    level = 5
    start = time.time()
    ...
    cv2.imwrite("D:\\VIT\\Academics\\Sem5\\Image\\Project Try 2\\Output\\green_water_4.jpg",fusion)
